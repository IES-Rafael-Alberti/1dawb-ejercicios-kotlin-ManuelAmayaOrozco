fun main(args: Array<String>) {
    ...
    por pantalla el IVA que se ha pagado y el importe sin IVA (suponiendo que se ha
    aplicado un tipo de IVA del 10%).
     */
    //ejercicio1_6()
    ...
    la cantidad de dinero depositada en la cuenta de ahorros, introducida por el usuario. Después
    el programa debe depositada en la cuenta de ahorros, introducida por el usuario. Después
    ...
    el prefijo es el código del país +34, y la extensión tiene dos dígitos (por ejemplo
    +34-913724710-56). Escribir un programa que pregunte por un número de teléfono con este formato
    ...
    día/mes/año y muestra por pantalla, el día, el mes y el año.
     */
    //ejercicio1_25()
